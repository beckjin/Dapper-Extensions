...
namespace DapperExtensions.Tests.IntegrationTests.KingbaseES
{
    ...
    {
        [TestFixture]
        public class InsertMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetListMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetFirstMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetPageMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : KingbaseESBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : KingbaseESBaseFixture
        {
            [Test]
