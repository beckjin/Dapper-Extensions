...
namespace DapperExtensions.Tests.IntegrationTests.Dameng
{
    ...
    {
        [TestFixture]
        public class InsertMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetListMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetFirstMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetPageMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : DamengBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : DamengBaseFixture
        {
            [Test]
