...
namespace DapperExtensions.Tests.IntegrationTests.OceanBase
{
    ...
    {
        [TestFixture]
        public class InsertMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetListMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetFirstMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetPageMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : OceanBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : OceanBaseFixture
        {
            [Test]
