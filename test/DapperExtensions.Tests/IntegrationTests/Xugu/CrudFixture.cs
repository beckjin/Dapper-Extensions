...
namespace DapperExtensions.Tests.IntegrationTests.Xugu
{
    ...
    {
        [TestFixture]
        public class InsertMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetListMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetFirstMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetPageMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : XuguBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : XuguBaseFixture
        {
            [Test]
