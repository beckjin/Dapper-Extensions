using DapperExtensions.Tests.Data;
...
namespace DapperExtensions.Tests.IntegrationTests.Highgo
{
    ...
    {
        [TestFixture]
        public class InsertMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class DeleteMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class UpdateMethod : HighgoBaseFixture
        {
            [Test]
            ...
            [Test]
            public void UsingPredicate_UpdatesSomeField()
            {
                Person p1 = new Person
                {
                    Active = true,
        ...
        [TestFixture]
        public class GetListMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetFirstMethod : HighgoBaseFixture
        {
            [Test]
            public void UsingPredicate_ReturnsFirst()
            {
                Db.Insert(new Person { Active = true, FirstName = "a", LastName = "a1", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = false, FirstName = "b", LastName = "b1", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = true, FirstName = "c", LastName = "c1", DateCreated = DateTime.UtcNow });
        ...
        [TestFixture]
        public class GetPageMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class CountMethod : HighgoBaseFixture
        {
            [Test]
        ...
        [TestFixture]
        public class GetMultipleMethod : HighgoBaseFixture
        {
            [Test]
            public void ReturnsItems()
            {
                Db.Insert(new Foo { FirstName = "a", LastName = "b", DateOfBirth = DateTime.UtcNow });
