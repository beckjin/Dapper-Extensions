...
using Animal = DapperExtensions.Tests.IntegrationTests.Oracle.Data.Animal;
using Person = DapperExtensions.Tests.IntegrationTests.Oracle.Data.Person;

namespace DapperExtensions.Tests.IntegrationTests.Oracle
{
    [TestFixture]
